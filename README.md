...
- Leaflet Map izulhq.github.io/leaflet-maps-with-google-sheets/
- Google Sheets template https://docs.google.com/spreadsheets/d/1-txnIl1WbSwOeGCzzJvh8fweRHmkHbAMEV8SSPlmWYQ/edit?gid=0#gid=0
